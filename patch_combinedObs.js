...
const hook = 'const [cachedDriveUrl, setCachedDriveUrl] = useState<string>(\'\');';

const injection = `
    const [cachedDriveUrl, setCachedDriveUrl] = useState<string>('');

    // --- AGREGADO: Calcular combinedObs dinamicamente para el Excel y Correo ---
