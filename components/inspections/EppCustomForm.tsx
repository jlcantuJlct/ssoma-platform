    ...
    const handleSaveAndDownload = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                alert('¡Inspección EPP guardada exitosamente en Drive y Base de Datos!');
    ...
    return (
        <div className="max-w-4xl mx-auto pb-24">
            ...
            <div className="px-4 space-y-6">
                ...
                <button onClick={handleSaveAndDownload} disabled={isSaving} className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-black py-4 rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-emerald-600/20 transition-transform active:scale-95 mt-8 disabled:opacity-50">
