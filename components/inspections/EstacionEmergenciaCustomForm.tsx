...
interface EstacionEmergenciaCustomFormProps {
    moduleName: string;
    version: number;
...
export function EstacionEmergenciaCustomForm({ moduleName, version, SignaturePad }: EstacionEmergenciaCustomFormProps) {
