    ...
    return (
        <div className="space-y-4 px-2 xl:px-6 pb-10 w-full max-w-full overflow-x-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-4 justify-between items-center bg-slate-900/50 backdrop-blur-md px-4 md:px-6 py-4 rounded-3xl shadow-2xl border-b border-emerald-500/30 ring-1 ring-slate-800">
                ...
                <div className="flex flex-wrap gap-2 md:gap-4 items-end justify-center md:justify-start w-full md:w-auto">
                ...
                <div className="flex gap-2 items-center shrink-0 w-full md:w-auto justify-center">
                    <button
                    ...
                    {!showAnalytics && <div className="hidden md:block h-8 w-px bg-slate-700 mx-1"></div>}
                    {!showAnalytics && (
