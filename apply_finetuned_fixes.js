            ...
            if (fs.existsSync(templatePath)) {
                ...
                templateDef.forEach((item: any, idx: number) => {
                    ...
                    if (ans) {
                        ...
                        if (normAns === 'NC' || normAns === 'FALSE' || normAns === '' || normAns.includes('NO')) {
                            hallazgosNC.push(\`- \${item.text}: NO CUMPLE\`);
                        }
                    }
                });
                ...
                if (hallazgosNC.length > 0) {
                    ...
                    finalObsText += 'HALLAZGOS REGISTRADOS (NO CUMPLE):\\n' + hallazgosNC.join('\\n');
                }
                ...
                templateDef.forEach((item: any, idx: number) => {
                    ...
                    if (targetRow !== -1) {
                        ...
                        } else if (normAns === 'NC' || normAns === 'FALSE' || normAns === '' || normAns.includes('NO')) {
...
console.log('Applied fine-tuned NC, Observaciones & Photo Sizing fixes!');
