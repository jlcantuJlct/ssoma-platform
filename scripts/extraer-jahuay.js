...
const ORIGINAL_DOC = 'C:\\Users\\jlcan\\Desktop\\Seguimiento de plataforma de seguridad Antigravity\\Informe mensual\\Peaje Jahuay Mayo.docx';
const OUTPUT_DIR = 'C:\\Users\\jlcan\\Desktop\\Seguimiento de plataforma de seguridad Antigravity\\ssoma-platform\\public\\referencias_jahuay';

if (!fs.existsSync(OUTPUT_DIR)) fs.mkdirSync(OUTPUT_DIR, { recursive: true });

console.log("Creando directorio de referencias Jahuay...");
...
const IGNORED_SHAPES = new Set([1, 2]);
...
console.log(`¡Listo! Se guardaron ${saved} imágenes de referencia para Jahuay.`);
