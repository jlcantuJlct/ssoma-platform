            ...
            {viewingFile && (
                <PreviewCarouselModal
                    ...
                    filename={(() => {
                        ...
                        return generateFilename(viewingFile.description || `Brigadista_${viewingFile.brigadistaType}`, viewingFile.date, viewingFile.responsible, ext as any, 'evidencia', viewingFile.location, 'seguridad');
                    })()}
                />
            )}
        </div>
