    ...
    return (
        <div className="flex h-screen bg-slate-950 text-slate-200 font-sans overflow-hidden selection:bg-red-500/30 w-full">
            <main className="flex-1 overflow-y-auto relative w-full h-full">
                <div className="fixed inset-0 pointer-events-none bg-gradient-to-bl from-red-900/10 via-slate-950 to-slate-950 z-0"></div>
                        ...
                        <div className="xl:col-span-2 space-y-6">
                            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl relative overflow-hidden min-h-[500px]">
                                <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                                    <Activity className="text-red-500" size={20} /> Historial de Brigadas
                                </h3>
                                                ...
                                                <tr key={record.id} className="hover:bg-slate-800/30 transition-colors group text-sm">
                                                    ...
                                                    <td className="py-4 text-right pr-4">
                                                        <div className="flex justify-end gap-1">
                                                            <button onClick={() => handleEdit(record)} className="p-2 text-slate-500 hover:text-blue-400 hover:bg-blue-500/10 rounded-lg transition-colors"><Pencil size={14}/></button>
                                                            <button onClick={() => handleDelete(record.id)} className="p-2 text-slate-500 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors"><Trash2 size={14}/></button>
                                                        </div>
                                                    </td>
                                                </tr>
                                            ))}
