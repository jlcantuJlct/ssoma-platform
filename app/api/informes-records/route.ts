...
export async function POST(req: NextRequest) {
    try {
        ...
        await db.execute('DELETE FROM informes_records');

        let query = 'INSERT INTO informes_records (id, date, month, description, responsable, zona, file_url, file_urls) VALUES ';
        const values: any[] = [];
